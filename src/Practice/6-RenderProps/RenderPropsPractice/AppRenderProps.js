...
function App() {    
    //Podemos ver que estamos usando el tipo child de render props. Entonces en lugar de crear un atributo render y setearle la funcion ejemplo: <DataFetcher render= () => {}
    //debemos hacer as Child Render Props lo siguiente:
    return (
        <div>
